 ...
 */
#ifndef MISSION_1_2_TOWER_PLANNING_HPP
#define MISSION_1_2_TOWER_PLANNING_HPP
...
// Sub CAV Selection
// ==============================
int select_sub_cav_for_two_vehicles(int main_cav_id,
                                     const std::vector<int>& precollision_candidates,
                                     Pose zone_origin,
                                     double overlap_threshold,
                                     int lookahead_distance);

#endif  // MISSION_1_2_TOWER_PLANNING_HPP

/*
 * Mission 1-2 CAV 제어 노드 전체에서 공유되는 자료구조와 위치(Localization) 전역 상태를 정의한다.
 * Planning/Control/Mission 알고리즘 구현은 포함하지 않는다.
 */
#ifndef MISSION_1_2_GLOBAL_HPP
#define MISSION_1_2_GLOBAL_HPP

/*
 * Mission 3 차량의 경로 추종을 위한 목표 Waypoint 탐색과 Lookahead 계산을 담당한다.
 * 목표 속도가 정해진 이후(Control)에 Lookahead가 정해지므로,
 * Closest Point/Corner 판단과 목표 Waypoint 탐색을 두 단계로 나누어 제공한다.
 */
#ifndef MISSION_3_CAV_PLANNING_HPP
#define MISSION_3_CAV_PLANNING_HPP
...
#endif  // MISSION_3_CAV_PLANNING_HPP
